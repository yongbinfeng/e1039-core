...
public:
    ...
    //double getDCA(int detectorID, int elementID, double tx, double ty, double x0, double y0); //WPM
    double getDCA(int detectorID, int elementID, double tx, double ty, double x0, double y0, double z0 = 0.); //WPM
