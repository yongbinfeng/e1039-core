...
KalmanFastTrackletting_Displaced::KalmanFastTrackletting_Displaced(const PHField* field, const TGeoManager* geom, bool flag)
  : KalmanFastTracking_Displaced(field, geom, flag)
{
...
KalmanFastTrackletting_Displaced::~KalmanFastTrackletting_Displaced()
{
  ;
}

int KalmanFastTrackletting_Displaced::setRawEvent(SRawEvent* event_input)
{
...
void KalmanFastTrackletting_Displaced::buildTrackletsInStation(int stationID, int listID, double* pos_exp, double* window)
{
