...
KalmanFastTrackletting_NEW_HODO_2::KalmanFastTrackletting_NEW_HODO_2(const PHField* field, const TGeoManager* geom, bool flag)
  : KalmanFastTracking_NEW_HODO_2(field, geom, flag)
{
...
KalmanFastTrackletting_NEW_HODO_2::~KalmanFastTrackletting_NEW_HODO_2()
{
  ;
}

int KalmanFastTrackletting_NEW_HODO_2::setRawEvent(SRawEvent* event_input)
{
...
void KalmanFastTrackletting_NEW_HODO_2::buildTrackletsInStation(int stationID, int listID, double* pos_exp, double* window)
{
