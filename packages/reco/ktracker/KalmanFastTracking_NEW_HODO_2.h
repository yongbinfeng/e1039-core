/*
KalmanFastTracking_NEW_HODO_2.h
...
#ifndef _KALMANFASTTRACKING_NEW_HODO_2_H
#define _KALMANFASTTRACKING_NEW_HODO_2_H
...
{
public:
    explicit KalmanFastTracking_NEW_HODO_2(const PHField* field, const TGeoManager *geom, bool flag = true);
    ~KalmanFastTracking_NEW_HODO_2();
